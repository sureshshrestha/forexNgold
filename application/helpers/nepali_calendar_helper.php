<?php 
	...
	class Nepali_Calendar {
		private $bs = array(
	 	...
	 	private $eng_date_only = array('year'=>'', 'month'=>'', 'date'=>'');
		...
		//THIS IS SECOND NEP_TO_ENG FOR FORMATED CONVERSION
		public function nep_to_eng_formated($yy,$mm,$dd){
			...
			if($this->is_range_nep($yy, $mm, $dd)===false){
				...
				$this->eng_date_only["year"] = $y;					
				$this->eng_date_only["month"] = $m;					
				$this->eng_date_only["date"] = $total_eDays;		
				return $this->eng_date_only;			
			}
		}		
	};
?>
